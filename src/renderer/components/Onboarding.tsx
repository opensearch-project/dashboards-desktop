      ...
      <div className="onboarding-content">
        ...
        {step === 1 && (
          <section aria-labelledby="conn-heading">
            <h2 id="conn-heading" ref={headingRef} tabIndex={-1}>Add a Data Source</h2>
            <p>Connect to an OpenSearch or Elasticsearch cluster. You can skip this and add one later.</p>
            <div className="form-group">
              <label htmlFor="ob-conn-name">Connection Name</label>
              <input id="ob-conn-name" value={connName} onChange={e => setConnName(e.target.value)} placeholder="e.g. prod-opensearch" />
            </div>
            <div className="form-group">
              <label htmlFor="ob-conn-url">URL</label>
              <input id="ob-conn-url" value={connUrl} onChange={e => setConnUrl(e.target.value)} placeholder="https://..." />
            </div>
            <div className="form-row">
              ...
              <div className="form-group">
                ...
                <select id="ob-auth-type" value={authType} onChange={e => setAuthType(e.target.value as AuthType)}>
            ...
            <div className="form-actions">
              ...
              <button className="btn-primary" onClick={saveConnection} disabled={!connName || !connUrl}>Next</button>
            </div>
          </section>
        )}
        ...
        {step === 2 && (
          <section aria-labelledby="ws-heading">
            <h2 id="ws-heading" ref={headingRef} tabIndex={-1}>Create a Workspace</h2>
