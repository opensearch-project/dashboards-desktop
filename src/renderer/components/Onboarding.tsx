            ...
            <ul className="prompt-suggestions" role="list">
              <li>
                <button
                  ...
                  onClick={() => onComplete('Show me cluster health')}
                >
                  Show me cluster health
                </button>
              </li>
              <li>
                <button className="suggestion-btn" onClick={() => onComplete('What can you do?')}>
                  What can you do?
                </button>
              </li>
              <li>
                <button className="suggestion-btn" onClick={() => onComplete('List my indices')}>
                  List my indices
                </button>
              </li>
            </ul>
